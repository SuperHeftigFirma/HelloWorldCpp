========================================================================
    KONSOLENANWENDUNG: UebungenKapitel2-Projektübersicht
========================================================================

Diese UebungenKapitel2-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre UebungenKapitel2-Anwendung besteht.


UebungenKapitel2.vcxproj
...
UebungenKapitel2.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen UebungenKapitel2.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
