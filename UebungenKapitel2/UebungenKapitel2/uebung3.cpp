...
{
	double h;
	std::cout << "Gebe die anfaengliche Höhe in Metern eines sich in Ruhe befindlichen Koerpers an, der dann unter Vernachlaessigung der Luftreibung zu Boden faellt: ";
	std::cin >> h;
...
void uebung3()
{
	...
	while (calculateNewHight(initialHeight, i) > 0)
	{
		printHight(calculateNewHight(initialHeight, i), i);
